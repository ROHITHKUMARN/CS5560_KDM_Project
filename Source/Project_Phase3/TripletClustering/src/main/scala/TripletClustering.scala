...
object TripletClustering {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val inputPath=Seq("data/MedTriplets")
    ...
    val cluster1= new PrintStream("data/cluster_1.txt")
    val cluster2= new PrintStream("data/cluster_2.txt")
    val cluster3= new PrintStream("data/cluster_3.txt")
    val cluster4= new PrintStream("data/cluster_4.txt")
    val cluster5= new PrintStream("data/cluster_5.txt")
    val cluster6= new PrintStream("data/cluster_6.txt")
    val cluster7= new PrintStream("data/cluster_7.txt")
    val cluster8= new PrintStream("data/cluster_8.txt")
    val cluster9= new PrintStream("data/cluster_9.txt")
    val cluster10= new PrintStream("data/cluster_10.txt")
    ...
    resultsA.foreach(f=>
     {
       if(f._2==0){
         cluster1.println(f._1)
       }
       else if(f._2==1){
         cluster2.println(f._1)
       }
       if(f._2==2){
         cluster3.println(f._1)
       }
       if(f._2==3){
         cluster4.println(f._1)
       }
       else if(f._2==4){
         cluster5.println(f._1)
       }
       if(f._2==5){
         cluster6.println(f._1)
       }
       if(f._2==6){
         cluster7.println(f._1)
       }
       else if(f._2==7){
         cluster8.println(f._1)
       }
       if(f._2==8){
         cluster9.println(f._1)
       }
       if(f._2==9){
         cluster10.println(f._1)
       }
     }
    )
    resultsA.foreach(f => {
  ...
  private def preprocess(sc: SparkContext, paths: Seq[String]): ( RDD[(Long,Vector)], RDD[(String,String)], Long) = {
    ...
    val dataframe1= sc.textFile("data/MedTriplets")
